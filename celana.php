...
<body>
  ...
  <!-- Produk -->
  <div class="container">
    <h2 class="text-center text-white fw-bold mb-4">Celana Pria</h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="c1.jpg" class="d-block w-100" alt="cel 21">
    </div>
    <div class="carousel-item">
      <img src="c2.jpg" class="d-block w-100" alt="cel 22">
    </div>
    <div class="carousel-item">
      <img src="c3.jpg" class="d-block w-100" alt="celana 23">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselProduk" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
          ...
          <div class="card-body">
            <h5 class="card-title">Celana Pria</h5>

            <p class="card-text text-dark">   Celana pria modern dengan desain slim fit yang cocok untuk gaya kasual maupun semi-formal. Terbuat dari bahan katun stretch yang nyaman, ringan, dan fleksibel saat digunakan                   </p>
            <h5 class="text-blue fw-bold">Rp 185.000</h5>
