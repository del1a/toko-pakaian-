...
<body>
  ...
  <!-- Produk -->
  <div class="container">
    <h2 class="text-center text-white fw-bold mb-4">Celana Anak</h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="l1.jpg" class="d-block w-100" alt="cel 24">
    </div>
    <div class="carousel-item">
      <img src="l2.jpg" class="d-block w-100" alt="cel 25">
    </div>
    <div class="carousel-item">
      <img src="l3.jpg" class="d-block w-100" alt="celana 0">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselProduk" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
          ...
          <div class="card-body">
            <h5 class="card-title">Celana Anak</h5>

            <p class="card-text text-dark">    Celana anak dengan bahan lembut dan ringan, dirancang khusus untuk kenyamanan dan kebebasan bergerak si kecil.        </p>
            <h5 class="text-blue fw-bold">Rp 165.000</h5>
