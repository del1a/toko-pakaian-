...
<body>
  ...
  <!-- Produk -->
  <div class="container">
    <h2 class="text-center text-white fw-bold mb-4">Baju Wanita</h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="p1.jpg" class="d-block w-100" alt="baju wanita 4">
    </div>
    <div class="carousel-item">
      <img src="p2.jpg" class="d-block w-100" alt="baju wanita 10">
    </div>
    <div class="carousel-item">
      <img src="p3.jpg" class="d-block w-100" alt="baju wanita 9">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselProduk" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark">Kemeja wanita dengan desain fit body yang elegan dan feminin. Terbuat dari bahan katun berkualitas yang adem, halus, dan menyerap keringat.Sweater wanita bergaya kasual dengan bahan rajut lembut dan elastis. Nyaman dipakai untuk aktivitas harian, cocok dipadukan dengan celana jeans atau rok.
                          </p>
            <h5 class="text-blue fw-bold">Rp 180.000</h5>
