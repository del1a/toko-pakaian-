...
<body>
  ...
  <!-- Produk -->
  <div class="container">
    <h2 class="text-center text-white fw-bold mb-4">Celana Wanita</h2>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="w1.jpg" class="d-block w-100" alt="cel 24">
    </div>
    <div class="carousel-item">
      <img src="w2.jpg" class="d-block w-100" alt="cel 25">
    </div>
    <div class="carousel-item">
      <img src="w3.jpg" class="d-block w-100" alt="celana 0">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselProduk" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
          ...
          <div class="card-body">
            <h5 class="card-title">Celana Wanita</h5>

            <p class="card-text text-dark">  Celana pendek wanita dengan desain modern dan potongan high-waist yang nyaman digunakan untuk aktivitas sehari-hari. Terbuat dari bahan ringan dan adem, cocok untuk tampilan santai maupun semi-kasual. Dilengkapi dengan kancing depan dan saku samping, memberikan sentuhan stylish namun tetap praktis.              </p>
            <h5 class="text-blue fw-bold">Rp 195.000</h5>
